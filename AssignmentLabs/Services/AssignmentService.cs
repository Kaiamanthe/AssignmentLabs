...
namespace AssignmentLibrary.Core.Services
{
    public class AssignmentService : IAssignmentService
    {
        ...
        public List<Assignment> ListIncomplete() => assignments.Where(a => !a.IsCompleted).ToList();
        public List<Assignment> ListAssignmentsByPriority() => assignments.OrderByDescending(a => a.Priority).ToList();
        public Assignment FindAssignmentByTitle(string title) => assignments.FirstOrDefault(a => a.Title.Equals(title, StringComparison.OrdinalIgnoreCase));
        ...
        public bool UpdateAssignment(string oldTitle, string newTitle, string newDescription, string notes, bool isComplete, Priority priority)
        {
            ...
            assignment.Update(newTitle, newDescription, notes, isComplete, priority);
        ...
        public bool UpdateNote(string title, string note)
        {
            ...
            assignment.Update(assignment.Title, assignment.Description, note, assignment.IsCompleted, assignment.Priority);
